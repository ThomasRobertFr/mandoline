...
public class MetadataTest {
    ...
    public void testGetSchemas() {
        ...
        try {
            ...
            assertEquals("getJSONCube did not return the Schemas captions ","Traffic",jsonObjectTest.getJSONObject("Traffic").getString("caption"));
    ...
    public void testGetDimensions() {
        ...
        try {
                ...
                assertEquals("the Dimension Zone does not have the type Geometry",result.getJSONObject("[Measures]").getString("type"),"Measure");
    ...
    public void testGetLevelProperties() {
        ...
        try {
                Level levelTest = olapConnection.getOlapCatalog().getSchemas().get("Traffic").
                    getCubes().get("Traffic").
                    getDimensions().get("Zone").
                    getHierarchies().get("Zone.Name").
                    getLevels().get("Name3");
            
                JSONObject result = (JSONObject)(getLevelProperties.invoke(metadata,levelTest));
                
                assertTrue("the result does not contain the property Traffic Cube - Zone.Name Hierarchy - Name3 Level - Geom Property",result.has("Traffic Cube - Zone.Name Hierarchy - Name3 Level - Geom Property"));
                assertEquals("the result does not contain a geometric property with the Geometry type",result.getJSONObject("Traffic Cube - Zone.Name Hierarchy - Name3 Level - Geom Property").get("type"), "Geometry");
    ...
    public void testGetMemberProperties() {
        ...
        try {
            ...
            Member memberTest = olapConnection.getOlapCatalog().getSchemas().get("Traffic").
                                    getCubes().get("Traffic").
                                    getDimensions().get("Zone").
                                    getHierarchies().get("Zone.Name").
                                    getLevels().get("Name3").
            ...
            assertEquals("the result does not contain the geometric property value in WKT format of Nordburgenland, the first member of Name3 ",result.get("Traffic Cube - Zone.Name Hierarchy - Name3 Level - Geom Property"), geometry);
    ...
    public void testGetGeometry() {
        try {
            ...
            assertEquals("the result is not the geometric property value in WKT format of Nordburgenland, the first member of Name3 ",result, geometry);
